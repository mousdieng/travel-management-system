...
import com.travelms.feedback.model.enums.Role;
...
public final class RoleUtil {
    ...
    /**
     * Check if the current user can manage reports
     * Only ADMIN can manage (review, view all) reports
     */
    public static boolean canManageReports() {
        return isAdmin();
    }
