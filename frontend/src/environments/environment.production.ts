export const environment = {
  production: true,
  apiUrl: '/api',  // Nginx will proxy /api to backend:8080
  // IMPORTANT: This must be your Stripe PUBLISHABLE key (pk_live_... for production)
  // Get your live publishable key from: https://dashboard.stripe.com/apikeys
  stripePublicKey: 'pk_live_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', // Replace with your Stripe LIVE PUBLISHABLE key
